...
<!-- What a user of the server can do differently, or what stops going wrong. -->

## Why

<!-- The panel behaviour, bug report or gap that motivated it. Link the issue if there is one. -->

## Verification

- [ ] `make fmt`, `make test` and `make lint` pass locally
